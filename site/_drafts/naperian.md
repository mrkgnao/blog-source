---
title: Naperian functors and corepresentability
subtitle: Working through Austin Seipp's Naperian.md
date: 2017-06-10
---
...
<section>
First, the requisite throat-clearing.
...
## Bounded natural numbers: `Fin`

First, we define the `Fin` type. There is a bijection

\\[ \\alpha : \\Fin n \\leftrightarrow 0 \\leq \\alpha < n \\]

We also define a safe smart constructor, `finite`.
...
> finite :: forall n. KnownNat n => Int -> Maybe (Fin n)
...
Pairs form one of the simplest Naperian types.
...
> 
> viota :: forall n. KnownNat n => Vector n (Fin n)
...
>   hreplicate  = Prism . hreplicate . pure
...
> 
> -- | Lift a unary function from values to hypercuboids of values.
...
> elements (Scalar a) = [a]
> elements (Prism a)  = elements a >>= toList
> 
...
>   v1, v2  :: Hyper '[Vector 3] Int
>   v1 = Prism (Scalar [1, 2, 3])
>   v2 = Prism (Scalar [4, 5, 6])
> 
